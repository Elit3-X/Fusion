...
<!-- FNXC:TaskResetDocs 2026-08-28-14:45: Task Reset is a destructive fresh-planning boundary. The guide must explain per-repository worktree and local-branch cleanup, retained history, fail-closed conflicts, recoverable retries, and atomic intake publication. -->
