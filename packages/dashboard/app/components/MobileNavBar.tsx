  ...
  */
  const destinationRegistry: Record<MobileNavSelectableItem, {
    ...
    */
    ...
    patchnode: { icon: <History />, labelKey: "nav.patchnode", fallback: "Patchnote", moreTestId: "mobile-more-item-patchnode", isActive: view === "patchnode", isAvailable: true, navigate: (surface) => surface === "primary" ? onChangeView("patchnode") : handleMoreAction(() => onChangeView("patchnode")) },
