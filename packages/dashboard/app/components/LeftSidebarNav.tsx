...
export function LeftSidebarNav({
  ...
  */
  ...
  /*
  FNXC:Navigation 2026-06-22-12:00:
  Single explicit sidebar order (top to bottom): dashboard, board, list, Patchnode, graph, planning, missions, agents, chat, mailbox, goals, compound, automation, import, workflows, insight, research, ideation, documents (Artifacts), skills, memory, evals, then any remaining plugin views in their sorted order.
